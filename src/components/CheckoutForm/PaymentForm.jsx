    ...
    const handleSubmit = async (event, elements, stripe) => {
        ...
        if(error){
            ...
            const orderData = {
                ...
                customer: {fullname: shippingData.fullname, email: shippingData.email},
                shipping: {street: shippingData.address, city: shippingData.city, state: shippingData.state, pincode: shippingData.pincode},
                payment: {
                   gateway:'stripe',
                   stripe: {
